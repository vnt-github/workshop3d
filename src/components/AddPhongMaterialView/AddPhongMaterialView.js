...
class AddPhongMaterialView extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            <ViewContainer>
                <ViewHeading>Add Phong Material</ViewHeading>
                <label>
                    Name
...
AddPhongMaterialView.propTypes = {
    callbacks: PropTypes.object.isRequired
};

export default AddPhongMaterialView;
