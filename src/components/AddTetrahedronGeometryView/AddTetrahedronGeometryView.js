...
class AddTetrahedronGeometryView extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            <ViewContainer>
                <ViewHeading>Add Tetrahedron Geometry</ViewHeading>
                <label>
                    Name
...
AddTetrahedronGeometryView.propTypes = {
    callbacks: PropTypes.object.isRequired
};

export default AddTetrahedronGeometryView;
