...
class AddBasicMaterialView extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            <ViewContainer>
                <ViewHeading>Add Basic Material</ViewHeading>
                <label>
                    Name
...
AddBasicMaterialView.propTypes = {
    callbacks: PropTypes.object.isRequired
};

export default AddBasicMaterialView;
